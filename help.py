def return_help_list():

    help_list = {
    "hello": "'Hey there!' şeklinde bir karşılama mesajı döner.",
    "burak": "Küfür eder.",
    "sorgu": "Trendyol sorgusu yapar. 2 saatte bir çalışır.",
    "sorgu bitir": "Trendyol sorgusunu bitirir.",
